...
import { categoryData, salesData } from "@/lib/mock-data";
  ...
  return (
    <div className="h-[280px] w-full" role="img" aria-label="Iyul oyidagi sotuv tushumi o‘sish grafigi">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={salesData} margin={{ top: 8, right: 4, left: -24, bottom: 0 }}>
          <defs>
          ...
          <XAxis dataKey="day" axisLine={false} tickLine={false} tick={{ fill: "currentColor", fontSize: 12 }} className="text-muted-foreground" dy={8} />
...
export function CategoryChart() {
  return (
    <div className="h-[220px] w-full" role="img" aria-label="Kategoriya bo‘yicha sotuvlar taqqoslanishi">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={categoryData} layout="vertical" margin={{ top: 8, right: 12, left: 4, bottom: 0 }}>
