...
import type { InventoryMovement } from "@/lib/commerce";
...
export function InventoryWorkspace() {
  ...
  useEffect(() => {
    apiRequest<{ movements: InventoryMovement[] }>("/api/inventory")
      .then((payload) => setMovements(payload.movements.map(formatMovement)))
